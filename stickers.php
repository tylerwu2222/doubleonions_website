    ...
    <body>
        ...
        <div id="main-div">
            ...
            if(isset($_GET['search'])){
                ...
                $sql = "SELECT * FROM products WHERE type='sticker' AND (tags LIKE '%$keyword%' OR name LIKE '%$keyword%')";
            }
            // print all items
            else{
                $sql = "SELECT * FROM products WHERE type='sticker'";
            }
